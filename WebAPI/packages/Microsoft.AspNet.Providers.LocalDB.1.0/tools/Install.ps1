...
try {
    # Set up variables
    $defaultConnectionString = "Data Source=(LocalDb)\v11.0;Initial Catalog=aspnetdb;AttachDBFilename=|DataDirectory|\aspnetdb.mdf;Integrated Security=SSPI"
    $oldConnectionName = "ApplicationServices"
    $timestamp = (Get-Date).ToString("yyyyMMddHHmmss")
    $connectionString ="Data Source=(LocalDb)\v11.0;Initial Catalog=aspnet-$($project.ProjectName)-$timestamp;AttachDBFilename=|DataDirectory|\aspnet-$($project.ProjectName)-$timestamp.mdf;Integrated Security=SSPI"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUkCTea6t2fh7aArUxZEvFCbc+
# Kq6gghUtMIIEoDCCA4igAwIBAgIKYRnMkwABAAAAZjANBgkqhkiG9w0BAQUFADB5
...
# p5MKVNGCalr7cKNiIKSj8k2kJ1wwTgYKKwYBBAGCNwIBDDFAMD6gJIAiAE0AaQBj
# AHIAbwBzAG8AZgB0ACAAQQBTAFAALgBOAEUAVKEWgBRodHRwOi8vd3d3LmFzcC5u
# ZXQvIDANBgkqhkiG9w0BAQEFAASCAQBLkTI1TMG4zc8+xZAq74vgcs+DWI+D5o/u
# 11ID1rkRXMVGOvqLLz2RsknNH6ECKhgQtF9d2UX/4IO7hR0EoWR8T5xpXvd0Kxe6
# 7Aa2TD9kYdNFGedbx4Va5vjBdhVRAqdB7VQaV99Kpbk9v2YMT5Lk+DiMFD/EFEWp
# kVdIwfehEbmCYfPHWcgqV1a0NPr/ZlDqogZbCGFpMgnD+qvWHj+aCzGWlv3RAYc4
# ld0OBUfiajD3eY+O5F+LJghnT0KW+zzPhi8t0QHXT5V6aOiDCwukdC7Dpon8CTZt
# wj1IqAwZLoTrRcLxOIVlHCwhAdGFZKyw9JCuzIlKojRq64f91CWsoYICHTCCAhkG
...
# BwEwHAYJKoZIhvcNAQkFMQ8XDTEyMDMzMDIwNDgzOVowIwYJKoZIhvcNAQkEMRYE
# FHPIIqv6n6k5mmeJljVjynrvsZGhMA0GCSqGSIb3DQEBBQUABIIBALWmdph+X8PW
# 7Hr1yGAW6zO7BS1o8mDpdH6hf6Ewsz/UXftFoByn9OM4qQ6nzIGBhFeKSz1xPCPF
# h4sKYiPscIZstdZJOZGJ55FQs8wdS0Hev1U1WQQyKmQVp3mAgOYYFDALVdHMLB4/
# FEnM12D//fz4ivV5o74o0yUDXEUHS04K8/K0vNGyDkax5CH5wi3ZA/WdxKEoEIcn
# tTNic3l69wG5pYL/WZ9cSoUGgN2bhyxdLxCinu+nFf8AN+q4VJvVz22SEobCF8L3
# G5MTLzSsvabaszZNDIw7rkHvv42ZsLI9BBog+xy9H9JJlpLMPeZTHy+QnoeJW7lM
# uzG6zg6iU2U=
